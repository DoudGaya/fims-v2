      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Enter the basic details for the new cluster.</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Textarea id="description" {...register('description')} rows={3} placeholder="Brief description of the cluster..." />
            </div>
          </CardContent>
        </Card>
